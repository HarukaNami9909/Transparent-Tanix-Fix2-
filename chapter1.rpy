...
label chpt_1_intro:
    ...
    menu:
        "I can do it!":
            ...
            lu "Great guilt took over the goddess, and so, she gave half of her soul to the bird."
            lu "Soon, his body changed from wings to arms, claws to nails, and much more."
        ...
        "I can't do it!":
            ...
            unknown "even without the usage of a goddess' powers." 
...
label Lucia_intro:
    ...
    menu:
        "Yes":
            ...
            lu "So, the goddess was able to restore Cunabula. As time passed, her power weakened as a phoenix is about to die."
            lu "Her life was fading, and so, she left her soul to a loyal female bird who wishes to take over for her."
        ...
        "No":
            "Oh, I see. Then I will not say anything about it!"
            lu "I’m just so happy I get to live like this!"
...
label Elsa_intro:
    ...
    lu "I would often see droplets of colorful feathers on the ground," 
    lu "allowing children and myself to collect many of them to decorate every room we own."  
...
label Luna_intro:
    ...
    lu "She was a child who would often scream out of nowhere."
...
label Luna_talk:
    ...
    lun "From your new friend?"
    ty "H-how did you know?"
    lun "Oh come on, Tyrus! Everyone is talking about it!"
    lun "You've been smiling a lot lately. Was it because of him?"
    ty "..."
    lu "(Tee-hee! He looks so cute whenever he blush!)"
    ty "*Ahem!*"
...
label continueon:
    ...
    "Their names engraved onto their tombstones, even their own feathers are piled on heavy rocks."
...
label no_names:
    ...
    lu "You’re staying in Cunabula for a purpose! Never to leave, always there to protect so many Cunablian's lives!"
